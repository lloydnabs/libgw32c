...
main (void)
{
  ...
  else if ((ls=lseek (fd, 0, SEEK_CUR)) != 0)
    {
      printf ("%d: lseek() returned different position: %ld %ld\n", __LINE__, ls, fs);
      result = 1;
    }
  ...
  if ((fs=fseeko (fp, 0, SEEK_SET)) != 0)
    ...
    {
      printf ("%d: lseek() returned different position from fseeko: %ld %ld\n", __LINE__, ls, fs);
      result = 1;
    }
  else if (fread (buf, sizeof (outstr) - 1, 1, fp) != 1)
    {
  ...
  if ((fs=fseek (fp, -((int) sizeof (outstr) - 1), SEEK_CUR)) != 0)
    {
      printf ("%d: fseek(fp, 0, SEEK_SET) failed\n", __LINE__);
      result = 1;
    }
  ...
  /* Now with fseeko.  */
  if ((fs=fseeko (fp, (int64_t) (-((int) sizeof (outstr) - 1)), SEEK_CUR)) != 0)
    {
      printf ("%d: fseeko(fp, 0LL, SEEK_SET) failed\n", __LINE__);
      result = 1;
    }
  else if (fflush (fp) != 0)
    {
  ...
  if ((fs=fseek (fp, -((int) sizeof (outstr) - 1), SEEK_END)) != 0)
    {
      printf ("%d: fseek(fp, 0, SEEK_SET) failed\n", __LINE__);
      result = 1;
    }
  ...
  /* Now with fseeko.  */
  if ((fs=fseeko (fp, -((int) sizeof (outstr) - 1), SEEK_END)) != 0)
    {
      printf ("%d: fseeko(fp, 0, SEEK_SET) failed\n", __LINE__);
      result = 1;
    }
...
//      goto out;
  ...
  if (fp == NULL)
    ...
    printf ("%d: fseeko: SEEK_END works\n", __LINE__);
  if (fp != NULL)
    fclose (fp);
